...
const Notfound = () => {
    return (
        <>
            <div className="container mt-28 mx-auto items-center">
                <center>
                    ...
                    <div className=" tracking-widest mt-4">
                        <span className="text-slate-500 text-6xl block mt-3"><span>4  0  4</span></span>
                        <span className="text-slate-500 text-xl pt-3">Maaf, halaman yang kamu minta tidak ditemukan!</span>

                    </div>
                </center>
                <center className="mt-6">
                    <a href='/' className="text-white font-sm text-xl bg-primary p-3 rounded-md hover:shadow-md hover:bg-opacity-60">Kembali ke Beranda </a>
                </center>
            </div>
